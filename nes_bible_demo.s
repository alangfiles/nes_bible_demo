...
;
	ldx     #$FE
	lda     #$A0
L3F27:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; old_x = BoxGuy1.x;
;
L36D7:	lda     _BoxGuy1+1
	sta     _old_x+1
	lda     _BoxGuy1
	sta     _old_x
;
...
; BoxGuy1.vel_x = 0;
;
L3F03:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L372C:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L3831:	ldy     _projectile_index
	lda     #$00
L3EF6:	sta     _projectiles_list,y
;
...
;
L4057:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L404F:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L4059:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2E48
;
...
;
	jmp     L4051
L405A:	lda     _sprite_frame_counter
	cmp     #$18
	bcs     L405B
;
; if (direction == LEFT)
...
;
	jmp     L4051
L405B:	lda     _sprite_frame_counter
	cmp     #$24
	bcs     L405C
;
; if (direction == LEFT)
