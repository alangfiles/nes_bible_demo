...
;
L3FD9:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L3FD1:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L3FDB:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2E48
;
...
;
	jmp     L3FD3
L3FDC:	lda     _sprite_frame_counter
	cmp     #$18
	bcs     L3FDD
;
; if (direction == LEFT)
...
;
	jmp     L3FD3
L3FDE:	lda     _sprite_frame_counter
	cmp     #$30
	bcs     L3FDF
;
; if (direction == LEFT)
