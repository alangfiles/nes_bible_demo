...
;
	ldx     #$FE
	lda     #$A0
L3F33:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; old_x = BoxGuy1.x;
;
L36D8:	lda     _BoxGuy1+1
	sta     _old_x+1
	lda     _BoxGuy1
	sta     _old_x
;
...
; BoxGuy1.vel_x = 0;
;
L3F0C:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L372D:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L3834:	ldy     _projectile_index
	lda     #$00
L3EFF:	sta     _projectiles_list,y
;
...
;
L4065:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L405D:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L4067:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2E49
;
...
;
	jmp     L405F
L4068:	lda     _sprite_frame_counter
	cmp     #$18
	bcs     L4069
;
; if (direction == LEFT)
...
;
	jmp     L405F
L4069:	lda     _sprite_frame_counter
	cmp     #$24
	bcs     L406A
;
; if (direction == LEFT)
...
;
	jmp     L405F
L406A:	lda     _sprite_frame_counter
	cmp     #$30
	bcs     L406B
;
; if (direction == LEFT)
