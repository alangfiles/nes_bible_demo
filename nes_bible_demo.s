...
;
L4084:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L407C:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L4086:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2E49
;
...
;
	jmp     L407E
L4089:	lda     _sprite_frame_counter
	cmp     #$30
	bcs     L408A
;
; if (direction == LEFT)
