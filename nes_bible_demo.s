...
;
L4363:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L435B:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L4365:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2F2B
;
...
;
	jmp     L435D
L4367:	lda     _sprite_frame_counter
	cmp     #$24
	bcs     L4368
;
; if (direction == LEFT)
