...
;
	ldx     #$FE
	lda     #$A0
L41BF:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; old_x = BoxGuy1.x;
;
L39CC:	lda     _BoxGuy1+1
	sta     _old_x+1
	lda     _BoxGuy1
	sta     _old_x
;
...
; BoxGuy1.vel_x = 0;
;
L419A:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L3A21:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L3B18:	ldy     _projectile_index
	lda     #$00
L418D:	sta     _projectiles_list,y
;
...
;
L42E7:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L42DF:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L42E9:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2E12
;
...
;
	jmp     L42E1
L42EA:	lda     _sprite_frame_counter
	cmp     #$18
	bcs     L42EB
;
; if (direction == LEFT)
...
;
	jmp     L42E1
L42EB:	lda     _sprite_frame_counter
	cmp     #$24
	bcs     L42EC
;
; if (direction == LEFT)
...
;
	jmp     L42E1
L42EC:	lda     _sprite_frame_counter
	cmp     #$30
	bcs     L42ED
;
; if (direction == LEFT)
